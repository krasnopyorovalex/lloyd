            ...
            <div class="container">
                <div class="custom-wrapper">
                    <div class="custom-box wow fadeInLeft">
                        ...
                        <p>Коррозия – это серьезный враг инфраструктуры и промышленности. Эффективная борьба коррозией возможна при умелом применении современных решений, которые обеспечивают максимальный срок службы конструкций и сооружений при оптимальных затратах на антикоррозионную защиту.</p>
                    </div>
